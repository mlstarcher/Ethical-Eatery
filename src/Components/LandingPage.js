  ...
  return (
    <Container className='d-flex align-text-center justify-content-between flex-column' style={{ minHeight: "100vh"}}>
      ...
      <Card style={{height: "65vh", border: "0px solid"}}>
        <img src="https://firebasestorage.googleapis.com/v0/b/ethical-eater.appspot.com/o/EERacoon2.jpg?alt=media&token=0fca548a-de84-47c0-96e2-e2d0eb93f590" style={{height: "auto", width: "50%", margin: "auto", display: `${showImage}`, transition: "display 0.5s ease-in-out"}}></img>
